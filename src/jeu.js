var jouer = (function () {
    ...
    var maxRange = 6;
    var nbInicoeur = 3;
    var cols=5;// (7 max) nombre de colonnes
    var rows=5;//(7 max)nombre de rangées	
    var nbclique = 0;

    //----DEBOGAGE-----//
    //var cols = 4; // (7 max) nombre de colonnes
    //var rows = 4; //(7 max)nombre de rangées	
    //var _niveau1 = [3, 5, 13, 2]; //
    //----FIN DEBOGAGE-----//


    var _jouer = function (jeu) {
    ...
    _jouer.prototype = {
        ...
        create: function () {
            ...
            _jeu.scoreJoueur = 0;
            nbMaxPieges = Math.round(rows * cols * 0.07); //nombre maximun de pieges peut creer
            ...
            _jeu.musique = _jeu.add.audio('bgMusique', 0.5);
            ...
            this.textChargement = _jeu.add.text(895, 415, _jeu.scoreJoueur, {
                font: "38px Arial",
                fill: 'rgb(0,255,0)'
            });
        ...
        creerTableau: function () {
            ...
            for (var i = 0; i < cols; i++) { //creation des rangées du tableau
                for (var j = 0; j < rows; j++) {
                    ...
                    if ((nombre == 0)||(nombre == 1)) {
                        ...
                        if (piege > nbMaxPieges) {
                            nombre += 2; //cree une autre tuile au lieu de la bombe
                        }
                    }
        ...
        flip: function (sprite1, pointer) {
            ...
            if (sprite1.idTuile == 'objet4') {
                ...
                _jeu.time.events.add(700, function () {
                    sprite1.faceFace.tint = 0x4d0026;
                });
                sprite1.inputEnabled = false;
                //sprite1.etatActif=false;
        ...
        valideMatch: function (monButon) {
            ...
            if (matchPossible == false) {
                ...
                _jeu.textNoMatch = _jeu.add.text(370, 350, "PLUS DE COMBINAISONS POSSIBLE", {
                    font: "36px Arial",
                    fill: "#e69900"
                });
        ...
        compareTuile: function (TabTuiles) {
            ...
            for (var i = 0; i < _TabTuiles.length; i++) {
                ...
                {
                    if ((_TabTuiles[i].idTuile !== "objet1") || (_TabTuiles[i].idTuile !== "objet4") || (_TabTuiles[i].idTuile !== "objet0")) {
        ...
        menuPause: function () {
            ...
            _jeu.textSourdine = _jeu.add.text(370, 350, "OFF", {
                font: "24px Arial",
                fill: "#e69900"
            });
            ...
            _jeu.textVolumeUp = _jeu.add.text(300, 350, "+", {
                font: "38px Arial",
                fill: "#e69900"
            });
            ...
            _jeu.textVolumeDown = _jeu.add.text(300, 420, "-", {
                font: "38px Arial",
                fill: "#e69900"
            })
        ...
        redemareJeu: function () {
            ...
            _jeu.time.events.add(2000, function () {
                ...
                nbVie = [];
                choixJoueur = [];
                _jeu.state.restart("Jouer"); //redemare le jeu 	
                _jeu.scoreJoueur;
